...
!(function () {
  ...
  var e,
    ...
    y = function (e, t) {
      return (
        (n = e), (r = t), p.call(n, r) && e[t] !== undefined && null !== e[t]
      );
      var n, r;
    },
    D = function (r) {
    ...
    Q = function (e) {
      var t, n, r, i;
      X(e)
        ? ((i = (r = e).parentNode), W.insertAfter(r, i), W.remove(i))
        : ((t = e),
          (n = W.create('figure', { class: 'image' })),
          W.insertAfter(n, t),
          n.appendChild(t),
          n.appendChild(
    ...
    ue = function (e, t) {
      ...
      return (
        Z(n, 'style', t.style),
        (!q(n) && '' === t.hspace) || ne(n, t.hspace),
        (!V(n) && '' === t.vspace) || re(n, t.vspace),
        (!$(n) && '' === t.border) || ie(n, t.border),
        (!K(n, 'borderStyle') && '' === t.borderStyle) || ae(n, t.borderStyle),
    ...
    de = function (e, t, n) {
      ...
      n
        ? (W.setAttrib(e, 'role', 'presentation'),
          ...
          L(r, 'alt', ''))
        : (U(t)
            ? ((r = E.fromDom(e)), (i = 'alt'), r.dom.removeAttribute(i))
            : ((r = E.fromDom(e)), L(r, 'alt', t)),
          'presentation' === W.getAttrib(e, 'role') &&
            W.setAttrib(e, 'role', ''));
    },
    ge = function (r, i) {
    ...
    fe = function (e, t, n) {
      ...
      me(n, o, t, 'caption', function (e, t, n) {
        ...
        me(n, o, t, 'src', Z),
        me(n, o, t, 'title', Z),
        me(n, o, t, 'width', ee(0, e)),
        me(n, o, t, 'height', ee(0, e)),
        me(n, o, t, 'class', Z),
        me(
          n,
          o,
        ...
        me(n, o, t, 'hspace', ge(ne, e)),
        me(n, o, t, 'vspace', ge(re, e)),
        me(n, o, t, 'border', ge(ie, e)),
        me(n, o, t, 'borderStyle', ge(ae, e)),
        (r = n),
        (i = o),
        ((a = t).alt === i.alt && a.isDecorative === i.isDecorative) ||
          de(r, a.alt, a.isDecorative);
    },
    pe = function (e, t) {
    ...
    ve = function (t, e) {
      var n = (function (e, t) {
        var n = document.createElement('img');
        if (
          (fe(e, c(c({}, t), { caption: !1 }), n),
          de(n, t.alt, t.isDecorative),
          t.caption)
        ) {
          var r = W.create('figure', { class: 'image' });
          return (
            r.appendChild(n),
            r.appendChild(
              W.create('figcaption', { contentEditable: 'true' }, 'Caption')
      ...
      t.dom.setAttrib(i, 'data-mce-id', null),
        oe(i) ? ((r = be(t, i)), t.selection.select(r)) : t.selection.select(i);
    },
    ye = function (t, e) {
      var n,
        r,
      ...
      fe(
        ...
        oe(s.parentNode)
          ? ((r = s.parentNode), be(t, r), t.selection.select(s.parentNode))
          : (t.selection.select(s),
            (i = t),
            (a = e),
            (l = function () {
              (o.onload = o.onerror = null),
                i.selection && (i.selection.select(o), i.nodeChanged());
            }),
            ((o = s).onload = function () {
              a.width ||
                a.height ||
    ...
    Ue = function (e, a) {
      ...
      return (
        Se.each(e, function (e) {
          ...
          e.menu !== undefined
            ? ((n = Ue(e.menu, a)), o.push({ text: i, items: n }))
    ...
    Le = function (r) {
      var t,
        ...
        b = v
          .some(r.getParam('image_prepend_url', '', 'string'))
          .filter(function (e) {
    ...
    Ee = function (e) {
      return { title: 'General', name: 'general', items: _e(e) };
    },
    Me = _e,
    je = function (e) {
      return {
    ...
    ze = function (e, t) {
      ...
      (n = e),
        ...
        (/^(?:[a-zA-Z]+:)?\/\//.test(r)
          ...
          t.setData({ src: { value: e, meta: i.src.meta } });
        });
    },
    Be = function (e, t) {
      var n,
      ...
      l !== undefined &&
        ...
        (i = n),
        (a = l),
        (r = e).hasDescription && w(a.alt) && (i.alt = a.alt),
        r.hasAccessibilityOptions &&
          (i.isDecorative = a.isDecorative || i.isDecorative || !1),
        r.hasImageTitle && w(a.title) && (i.title = a.title),
        r.hasDimensions &&
          (w(a.width) && (i.dimensions.width = a.width),
          w(a.height) && (i.dimensions.height = a.height)),
        w(a['class']) &&
          Ne(r.classList, a['class']).each(function (e) {
            i.classes = e.value;
          }),
        r.hasImageCaption && C(a.caption) && (i.caption = a.caption),
        r.hasAdvTab &&
          (w(a.style) && (i.style = a.style),
          w(a.vspace) && (i.vspace = a.vspace),
          w(a.border) && (i.border = a.border),
          w(a.hspace) && (i.hspace = a.hspace),
          w(a.borderstyle) && (i.borderstyle = a.borderstyle)),
        t.setData(n));
    },
    He = function (e, t, n, r) {
      ...
      return (
        (u.vspace =
          ...
          r['margin-top'] === r['margin-bottom']
            ? B(String(r['margin-top']))
            : ''),
        (u.hspace =
          (i = s)['margin-right'] &&
          i['margin-left'] &&
          i['margin-right'] === i['margin-left']
            ? B(String(i['margin-right']))
            : ''),
        (u.border = (a = s)['border-width']
          ? B(String(a['border-width']))
          : ''),
      ...
      return function (e, t) {
        ...
        'src' === t.name
          ...
          ? ((c = h),
            ...
            (d = v),
            (f = (g = e).getData()),
            (p = Ne(m.imageList, f.images)).each(function (e) {
              '' === f.alt ||
              d.prevImage
                .map(function (e) {
                  return e.text === f.alt;
          ...
          ? ((o = h),
            (s = (l = e).getData()),
            (u = Fe(o.parseStyle, o.serializeStyle, s)),
            l.setData(u))
          : 'vspace' === t.name ||
            'hspace' === t.name ||
            'border' === t.name ||
          ...
          ? ((n = h),
            (r = e),
            (i = Ae(Re(b.image), r.getData())),
            (a = ue(n.normalizeCss, ke(i, !1))),
            r.setData({ style: a }))
          : 'fileinput' === t.name
          ? Ge(h, b, v, e)
          : 'isDecorative' === t.name &&
          ...
          onSubmit: function (n) {
            return function (e) {
              ...
              s.execCommand(
                'mceUpdateImage',
                !1,
                ke(t, n.hasAccessibilityOptions)
              ),
          ...
          uploadImage:
            ...
            function (e) {
              return we(t)
                ...
                .then(function (e) {
                  return 0 === e.length
                    ? j.reject('Failed to upload image')
                    : !1 === e[0].status
                    ? j.reject(e[0].error.message)
                    : e[0];
                });
            }),
        };
    ...
    Je = function (u) {
      u.addCommand('mceImage', $e(u).open),
              ...
              void ((l = he((t = u)))
                ? ((n = ce(function (e) {
                  ...
                  (r = c(c({}, n), e)).src
                    ...
                    : ((i = t),
                      (a = l) &&
                        ((o = i.dom.is(a.parentNode, 'figure.image')
                          ? a.parentNode
                          : a),
                        i.dom.remove(o),
                        i.focus(),
                        i.nodeChanged(),
                        i.dom.isEmpty(i.getBody()) &&
  ...
  i.add('image', function (e) {
    ...
    (t = e).on('PreInit', function () {
      t.parser.addNodeFilter('figure', Ke(!0)),
        t.serializer.addNodeFilter('figure', Ke(!1));
    }),
