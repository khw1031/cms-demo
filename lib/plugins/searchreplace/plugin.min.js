  ...
  var e,
    ...
    H =
      ...
      (i = 'text'),
      {
        ...
        set: function (e, t) {
          if (!o(e))
            throw new Error(
              'Can only set raw ' + i + ' value of a ' + i + ' node'
            );
          e.dom.nodeValue = t;
        },
      }),
    ...
    U = function (e, t) {
      return (
        ...
        0 === o.childElementCount
          ? []
          : S(i.querySelectorAll(n), W.fromDom)
      );
      var n, r, o, i;
    },
    ...
    Y = function (e, t, n, r, o) {
      ...
      z((i = e), (a = n)) ||
        ...
        (s = new $(n, l)),
        (f = o ? s.next.bind(s) : s.prev.bind(s)),
        X(e, f, n, {
          boundary: m,
          cef: m,
          text: function (e) {
            o ? (t.fOffset += e.length) : (t.sOffset += e.length),
              t.elements.push(W.fromDom(e));
          },
        }));
    },
    ...
    ve = function (e, t, n, r, o) {
      ...
      for (
        var l = e.getBody(),
          s = x.grep(x.toArray(l.getElementsByTagName('span')), pe),
          f = 0;
        f < s.length;
        f++
      ) {
    ...
    ye = function (e, t, n) {
      for (
        var r,
          o,
          i = t.get(),
          a = x.toArray(e.getBody().getElementsByTagName('span')),
          u = 0;
        u < a.length;
        u++
      ) {
    ...
    be = function (i, a) {
      ...
      i.undoManager.add();
      var n = x.trim(i.selection.getContent({ format: 'text' })),
        u = function (e) {
