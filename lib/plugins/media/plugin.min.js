  ...
  var e,
    ...
    D = function (i, e) {
      ...
      return (
        A({
          ...
          start: function (e, t) {
            if (!c.get())
              if (O(t.map, 'data-ephox-embed-iri'))
                c.set(!0),
                  (o = (n = t).map.style),
                  (a = o ? C.parseStyle(o) : {}),
                  (u = {
                ...
                if (
                  ...
                  ('iframe' !== e &&
                    ...
                    'video' !== e &&
                    'audio' !== e) ||
                    (u.type || (u.type = e), (u = _.extend(t.map, u))),
                  'script' === e)
                ) {
                  var r = T(i, t.map.src);
                  if (!r) return;
              ...
              if (!m.get())
                if (O(t.map, 'data-ephox-embed-iri'))
                  m.set(!0),
                    (n = c),
                    (a = (o = t).map.style),
                    ((i = a ? z.parseStyle(a) : {})['max-width'] = N(n.width)),
                    (i['max-height'] = N(n.height)),
                    U(o, { style: z.serializeStyle(i) });
                else {
                  switch (e) {
                    case 'video':
                    case 'object':
    ...
    q = function (r, e) {
      ...
      if (
        ...
        return R(n.embed, n, !0);
      var o = T(S(r), n.source);
      o &&
        ((n.type = 'script'),
        (n.width = String(o.width)),
        (n.height = String(o.height)));
      var a,
        i,
        c,
        u,
        ...
        ? ((o = t),
          ...
          new B(function (t, e) {
            var r = function (e) {
              return (
                e.html && (W[o.source] = e),
                t({ url: o.source, html: e.html ? e.html : a(o) })
              );
            };
            W[o.source] ? r(W[o.source]) : i({ url: o.source }, r, e);
          }))
        : ((r = t),
          (n = G(e)),
          new B(function (e) {
    ...
    K = function (e, t) {
      ...
      return p(
        ...
        ((r = o),
        (n = {}),
        j(e, 'dimensions').each(function (e) {
    ...
    Q = function (e) {
      var n = p(p({}, e), {
        source: { value: j(e, 'source').getOr('') },
        altsource: { value: j(e, 'altsource').getOr('') },
        poster: { value: j(e, 'poster').getOr('') },
      });
      return (
        w(['width', 'height'], function (r) {
    ...
    ee = function (e, t, r) {
      ...
      (t.embed = R(t.embed, t)),
        t.embed &&
        (e.source === t.source || ((n = t.source), W.hasOwnProperty(n)))
          ? Z(r, t.embed)
          : H(r, t)
              .then(function (e) {
                Z(r, e.html);
        ...
        h = m.windowManager.open({
          ...
          onChange: function (e, t) {
            switch (t.name) {
              case 'source':
                (s = d.get()),
                  (l = K(e.getData(), 'source')),
                  s.source !== l.source &&
                    (Y(h, m)({ url: l.source, html: '' }),
    ...
    ce = function (e, t, r) {
      var n = 'img' === t.name || 'video' === e.name,
        ...
        i = n ? a : null;
      t.attr({ width: ie(e, r, 'width', o), height: ie(e, r, 'height', i) });
    },
    ue = function (e, t) {
      var r = t.name,
        n = new re('span', 1);
      n.attr({
        ...
        se(e, t, n);
      var o,
        a = e.dom.parseStyle(t.attr('style')),
        i = new re(r, 1);
      ce(t, i, a),
        i.attr({
          src: t.attr('src'),
    ...
    me = function (s) {
      return function (e) {
        for (var t, r, n, o, a, i, c, u = e.length; u--; )
          (t = e[u]).parent &&
            (t.parent.attr('data-mce-object') ||
              ('script' === t.name && !(r = T(S(s), t.attr('src')))) ||
              (r &&
                (r.width && t.attr('width', r.width.toString()),
                r.height && t.attr('height', r.height.toString())),
              ('iframe' === (c = t.name) || 'video' === c || 'audio' === c) &&
              s.getParam('media_live_embeds', !0) &&
              ne.ceFalse
                ? le(t) || t.replace(ue(s, t))
                : le(t) ||
                  t.replace(
                    ((n = s),
                    (i = void 0),
                    (a = (o = t).name),
                    ((i = new re('img', 1)).shortEnded = !0),
                    se(n, o, i),
                    ce(o, i, {}),
                    i.attr({
                      style: o.attr('style'),
    ...
    return (
              ...
              if ((r = e[l]).parent) {
                ...
                'script' === u && n.attr('type', 'text/javascript'),
                  (i = r.attr('data-mce-html')) &&
                    (((c = new re('#text', 3)).raw = !0),
                    (c.value = ae(d, unescape(i))),
                    n.append(c)),
                  r.replace(n);
              }
          });
      ...
      r.on('ObjectResized', function (e) {
        ...
        r.getAttribute('data-mce-object') &&
          ...
          r.setAttribute(
            'data-mce-html',
            escape(R(t, { width: String(e.width), height: String(e.height) }))
          ));
      }),
      (n = e),
      {
