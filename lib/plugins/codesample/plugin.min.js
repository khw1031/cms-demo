                  ...
                  (function () {
                    var e = (function (u) {
                      var c = /\blang(?:uage)?-([\w-]+)\b/i,
                        ...
                        C = {
                          ...
                          util: {
                            encode: function r(e) {
                              return e instanceof O
                                ? new O(e.type, r(e.content), e.alias)
                                : Array.isArray(e)
                                ? e.map(r)
                                : e
                                    .replace(/&/g, '&amp;')
                            ...
                            DFS: function l(e, n, t, a) {
                              ...
                              for (var o in e) {
                                e.hasOwnProperty(o) &&
                                  (n.call(e, o, e[o], t || o),
                                  (r = e[o]),
                                  'Object' !== (s = C.util.type(r)) || a[i(r)]
                                    ? 'Array' !== s ||
                                      a[i(r)] ||
                                      ((a[i(r)] = !0), l(r, n, o, a))
                                    : ((a[i(r)] = !0), l(r, n, null, a)));
                              }
                            },
                          },
                          plugins: {},
                          ...
                          highlightElement: function (e, n, t) {
                            ...
                            if (
                              (C.hooks.run('before-sanity-check', o), !o.code)
                            )
                              return (
                                C.hooks.run('complete', o),
                            ...
                            C.hooks.run('before-highlight', o),
                              o.grammar
                                ? n && u.Worker
                                  ...
                                  : l(
                                      C.highlight(o.code, o.grammar, o.language)
                                    )
                      ...
                      return (
                        t &&
                          ((C.filename = t.src),
                          t.hasAttribute('data-manual') && (C.manual = !0)),
                        C.manual ||
              ...
              function (e, n, t) {
                !(function (t) {
                  ...
                  var S = F + '|' + P,
                    ...
                    z = /\b(?:assembly|event|field|method|module|param|property|return|type)\b/
                      .source,
                            ...
                            (function b(e) {
                              for (
                                ...
                                var t,
                                  ...
                                  d = e[n];
                                'string' == typeof d ||
                                (d.content && 'string' == typeof d.content)
                                  ? ((t = f[m]),
                                    (a = p.tokenStack[t]),
                                    (r = 'string' == typeof d ? d : d.content),
                                    (s = h(g, t)),
                                    -1 < (i = r.indexOf(s)) &&
                                      (++m,
                                      (o = r.substring(0, i)),
                                      (l = new y.Token(
                                        g,
                                        y.tokenize(a, p.grammar),
                                        'language-' + g,
                                        a
                                      )),
                                      (u = r.substring(i + s.length)),
                                      (c = []),
                                      o && c.push.apply(c, b([o])),
                                      c.push(l),
                                      u && c.push.apply(c, b([u])),
                                      'string' == typeof d
            ...
            11: [
              function (e, n, t) {
                !(function (n) {
                  ...
                  n.languages.insertBefore('php', 'variable', { string: o }),
