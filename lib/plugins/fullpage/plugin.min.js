    ...
    d = function (l, i) {
      var e,
        ...
        s =
          ...
          (n = r.getAll('html')[0]) &&
            (a.langcode = c(n, 'lang') || c(n, 'xml:lang')),
          (a.stylesheets = []),
          ...
          (n = r.getAll('body')[0]) &&
            ((a.langdir = c(n, 'dir')),
            (a.style = c(n, 'style')),
            (a.visited_color = c(n, 'vlink')),
            (a.link_color = c(n, 'link')),
            (a.active_color = c(n, 'alink'))),
          a),
        d = u(
          u(
            {},
          ...
          var t = e.getData(),
            n = (function (e, o, t) {
              ...
              s ||
                ((r = c.getAll('html')[0]),
                (s = new m('head', 1)),
                r.firstChild ? r.insert(s, r.firstChild, !0) : r.append(s)),
                (r = c.firstChild),
                o.xml_pi
                  ? ((n = 'version="1.0"'),
                    o.docencoding && (n += ' encoding="' + o.docencoding + '"'),
                    7 !== r.type &&
                      ((r = new m('xml', 7)), c.insert(r, c.firstChild, !0)),
                    (r.value = n))
                  : r && 7 === r.type && r.remove(),
                ...
                o.doctype
                  ? (r ||
                      ((r = new m('#doctype', 10)),
                      o.xml_pi ? c.insert(r, c.firstChild) : a(r)),
                    (r.value = o.doctype.substring(9, o.doctype.length - 1)))
                  : r && r.remove(),
                (r = null),
                p.each(c.getAll('meta'), function (e) {
