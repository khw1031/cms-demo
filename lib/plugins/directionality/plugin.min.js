...
!(function () {
  ...
  var n,
    ...
    L = function (n, t) {
      return (e = n).style !== undefined && h(e.style.getPropertyValue)
    ...
    R = function (n) {
      return 'rtl' ===
        ((e = 'direction'),
        (o = (t = n).dom),
        '' !== (r = window.getComputedStyle(o).getPropertyValue(e)) || S(t)
          ? r
          : L(o, e))
        ? 'rtl'
        : 'ltr';
