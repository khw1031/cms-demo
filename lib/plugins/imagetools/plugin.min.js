    ...
    x = window.Promise
      ...
      : ((i = function (t) {
          ...
          (this._state = null),
            (this._value = null),
            (this._deferreds = []),
            c(t, a(L, this), a(j, this));
        }),
        (o = window),
        (u =
          i.immediateFn ||
          ('function' == typeof o.setImmediate && o.setImmediate) ||
          function (t) {
    ...
    try {
      ...
      if (t && ('object' == typeof t || 'function' == typeof t)) {
        ...
        if ('function' == typeof e)
          return void c(a(e, t), a(L, this), a(j, this));
      }
  ...
  var O = function (a) {
    ...
    S = function (n) {
      return new x(function (t, e) {
        (function (t) {
          ...
          return b.some(new Blob(c, { type: r }));
        })(n).fold(function () {
    ...
    B = function (t) {
      return O(t).then(function (t) {
        ...
        var e,
          n,
          r = _(
            (n = t).naturalWidth || n.width,
            (e = t).naturalHeight || e.height
          );
    ...
    Ut = function (t, e) {
      ...
      return (
        0 === n.indexOf('data:') ||
        0 === n.indexOf('blob:') ||
        new mt(n).host === t.documentBaseURI.host
      );
    },
    At = function (t, e) {
      return (
    ...
    Et = function (t, e) {
      return (
        (n = t),
        b.from(n.getParam('imagetools_fetch_image', null, 'function')).fold(
          function () {
            return xt(t, e);
          },
          function (t) {
    ...
    (n = t),
      ...
      (u = t).on('NodeChange', function (t) {
        ...
        e &&
          ...
          (jt(a), u.editorUpload.uploadImagesAuto(), c.set(null)),
          n.each(c.set);
      });
  });
})();
