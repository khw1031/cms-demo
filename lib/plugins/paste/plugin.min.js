  ...
  var e,
    ...
    V = function (t, e) {
      return (
        j.each(e, function (e) {
          t =
            e.constructor === RegExp ? t.replace(e, '') : t.replace(e[0], e[1]);
        }),
        t
      );
    },
      ...
      for (
        var a,
          ...
          u = function (e) {
            ...
            else if ((e = e.firstChild)) for (; u(e), (e = e.next); );
          },
          t = function (e, t, n) {
            var r = e._listLevel || i;
            r !== i && (a = r < i ? a && a.parent.parent : ((o = a), null)),
              a && a.name === t
                ? a.append(e)
                : ((o = o || a),
                  (a = new U(t, 1)),
    ...
    Y = function (r, e) {
      ...
      var n = r.getParam(
        ...
        o = q({ valid_elements: n, valid_children: '-li[p]' });
            ...
            (function (n, r, a, o) {
              ...
              return (
                ...
                /(bold)/i.test(s['font-weight']) &&
                  (delete s['font-weight'], a.wrap(new U('b', 1))),
                /(italic)/i.test(s['font-style']) &&
                  (delete s['font-style'], a.wrap(new U('i', 1))),
      ...
      var s = i.parse(e);
      return (
        r.getParam('paste_convert_word_fake_lists', !0) && W(s),
        (e = z({ validate: I(r) }, o).serialize(s))
      );
    },
    Z = function (e, t) {
    ...
    G = function (e, t, n, r) {
      var a,
        ...
        h = (function (e, t) {
          ...
          return z({ validate: I(e) }, e.schema).serialize(r);
        })(e, v.content);
      return e.hasEventListeners('PastePostProcess') && !v.isDefaultPrevented()
        ? ((u = h),
          ...
          Z(g.node.innerHTML, g.isDefaultPrevented()))
        : Z(h, v.isDefaultPrevented());
    },
    J = function (e, t, n) {
      var r,
        a,
        ...
        i = o
          ? ((a = t),
            (r = e).getParam('paste_enable_default_filters', !0) ? Y(r, a) : a)
          : t;
      return G(e, i, n, o);
    },
    Q = function (e, t) {
    ...
    ne = function (e, t, n) {
      return (
        !(!1 !== e.selection.isCollapsed() || !ee(t)) &&
        ((a = t),
        (o = n),
    ...
    ie = function (e, t) {
      ...
      return ((o = {
        pcIsSpace: !(a = function (e, t) {
          return -1 !== ' \f\t\x0B'.indexOf(t) || '\xa0' === t
            ? e.pcIsSpace ||
              '' === e.str ||
              e.str.length === s.length - 1 ||
              ((n = s), (r = e.str.length + 1) < n.length && 0 <= r && oe(n[r]))
              ? { pcIsSpace: !1, str: e.str + '\xa0' }
              : { pcIsSpace: !0, str: e.str + ' ' }
            : { pcIsSpace: oe(t), str: e.str + t };
          var n, r;
        }),
        str: '',
      }),
          ...
          ? ((l = void 0),
            (o = (a = e.editorUpload.blobCache).getByData(v, h))
              ...
              : ((s = (i = e.getParam('images_reuse_filename') && P(b.name))
                ...
                a.add(l)),
            ue(e, '<img src="' + l.blobUri() + '">', !1))
          : ue(e, '<img src="' + t.uri + '">', !1);
    },
    ge = function (e) {
      return k.all(
        b(e, function (r) {
    ...
    ye = function (e) {
      return (
        (S.metaKeyPressed(e) && 86 === e.keyCode) ||
    ...
    be = function (s, v, u) {
      ...
      s.on('keyup', f.clear),
        s.on('keydown', function (e) {
          ...
          if (ye(e) && !e.isDefaultPrevented()) {
            if (
              (l = e.shiftKey && 86 === e.keyCode) &&
              T.webkit &&
              -1 !== navigator.userAgent.indexOf('Version/')
            )
              return;
            if ((e.stopImmediatePropagation(), c.set(e), f.set(!0), T.ie && l))
              return (
                e.preventDefault(),
                (t = !0),
      ...
      s.on('paste', function (e) {
        ...
        (l = !1),
          ...
          (de(a) || !he(s, e, v.getLastRng() || s.selection.getRng()))
            ? (t || e.preventDefault(),
              !T.ie ||
                (t && !e.ieFake) ||
                fe(a, 'text/html') ||
    ...
    Se = function (e, t, n) {
      if (
        ((r = e),
        !1 !== T.iOS || 'function' != typeof (null == r ? void 0 : r.setData))
      )
        return !1;
      try {
        return (
    ...
    Oe = function (e, t, n, r) {
      Se(e.clipboardData, t.html, t.text)
        ? (e.preventDefault(), r())
        : n(t.html, r);
    },
    je = function (s) {
    ...
    Ie = function (e) {
      ...
      e.on(
        ...
        function (e) {
          Ae(t) &&
            Oe(e, Re(t), je(t), function () {
              var e;
              T.browser.isChrome() || T.browser.isFirefox()
    ...
    Ne = function (i, s, u) {
      i.getParam('paste_block_drop', !1) &&
        ...
        i.on('dragover dragend', function (e) {
          R(i) && !1 === u.get() && (e.preventDefault(), Me(i, Ee(i, e))),
