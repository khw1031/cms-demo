  ...
  var e,
    ...
    C = d(
      [
        ...
        { key: 'advcode', name: 'Advanced Code Editor*', type: x },
        { key: 'formatpainter', name: 'Format Painter*', type: x },
        { key: 'powerpaste', name: 'PowerPaste*', type: x },
        { key: 'tinydrive', name: 'Tiny Drive*', type: x },
        { key: 'tinymcespellchecker', name: 'Spell Checker Pro*', type: x },
        { key: 'a11ychecker', name: 'Accessibility Checker*', type: x },
        { key: 'linkchecker', name: 'Link Checker*', type: x },
        { key: 'mentions', name: 'Mentions*', type: x },
        { key: 'mediaembed', name: 'Enhanced Media Embed*', type: x },
        { key: 'checklist', name: 'Checklist*', type: x },
        { key: 'casechange', name: 'Case Change*', type: x },
        { key: 'permanentpen', name: 'Permanent Pen*', type: x },
        { key: 'pageembed', name: 'Page Embed*', type: x },
        {
          key: 'tinycomments',
          name: 'Tiny Comments*',
          type: x,
        ...
        { key: 'advtable', name: 'Advanced Tables*', type: x },
        { key: 'autocorrect', name: 'Autocorrect*', type: x },
        { key: 'export', name: 'Export*', type: x },
      ],
      function (e) {
        return m(m({}, e), {
    ...
    M = function (e, t) {
      ...
      return (
        (r = e),
        p.from(r.getParam('help_tabs')).fold(
          function () {
            return (
              (t = y((e = h))),
